...
<!-- Navbar Start -->
<div style="z-index: 1000088;background: white;display: block;"  class="navbar navbar-expand-lg bg-ghostwhite navbar-light bg-white shadow  sticky-top p-0 wow zoomIn"  data-wow-delay="0.1s">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <center> @include('layouts/includes/ourschool')</center>
