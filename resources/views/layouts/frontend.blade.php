...
<head>
    <meta charset="utf-8">
    <title>EMAUS Ishuri rya Bibiliya M'Urwanda</title>
...
<body>
    <?= $this->include('layouts/includes/header.php') ?>
    
   <?= $this->include('layouts/includes/ourschool.php') ?>
    <?= $this->include('layouts/includes/home.php') ?> 
    <?= $this->include('layouts/includes/services.php') ?>
    <?= $this->include('layouts/includes/categories.php') ?>
    <?= $this->include('layouts/includes/courses.php') ?>
    <?= $this->include('layouts/includes/team.php') ?>
    <?= $this->include('layouts/includes/testimonials.php') ?>
    <?= $this->include('layouts/includes/footer.php') ?>
