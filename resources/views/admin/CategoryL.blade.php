                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($bookCategories as $index => $bookCategory)
                                <tr>
                                    <th scope="row">{{ $index + 1 }})</th>
                                    <td>{{ $bookCategory->book_category }}</td>
                                    <td> <a href="{{ route('UpdateCat',$bookCategory->id) }}" class="btn btn-success btn-sm" style="margin-right: 2vh;color: darkgrey;">Edit</a><a href="" class="btn btn-danger btn-sm" style="color: darkgrey;">Remove</a></td>
