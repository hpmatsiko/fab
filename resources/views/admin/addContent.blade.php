    ...
    <div class="row g-4">
        <div style="" class="col-sm-12 col-xl-12">
            <div class="bg-secondary rounded h-100 p-4">
                <h6 style="color: #198754;" class="mb-4">Welcome page content</h6>
                ...
                <form method="post" action="{{ route('saveContent') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-12">
                            <textarea id="note" class="form-control @error('content') is-invalid @enderror" name="content" placeholder="Write welcome content">{{ old('note') }}</textarea>
                            @error('note')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
