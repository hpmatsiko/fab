...
<div style="" class="col-sm-12 col-xl-12">
    <div class="bg-secondary rounded h-100 p-4">
        <h6 style="color:#198754 ;" class="mb-4">Updating Ibitabo</h6>
        ...
        <form  method="post" action="{{ route('UpdateCat',$cat->id) }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="inputEmail3"  name="title" value="{{ $cat->book_category }}" placeholder="Uzuza Izina Rya Kategori">
                    @error('title')
